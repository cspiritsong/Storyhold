...
- **Storyhold About version lookup after repository rename.** The About dialog now reads the manifest from the renamed Storyhold install directory instead of the retired Smart-Memory path.

## [1.10.1] - 2026-08-21

### Fixed

- **Storyhold settings path after repository rename.** The runtime now requests `settings.html` from the renamed `third-party/Storyhold` install directory instead of the retired `third-party/Smart-Memory` path.
